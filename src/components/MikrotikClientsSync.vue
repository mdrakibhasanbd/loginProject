<template>
    <Sidebar>
        ...
        <TableBodyLayout>
            ...
            <Drawer :rowData="selectedRows" :itemsPerPage="itemsPerPage" @send-selected-rows="sendSelectedRowsDrawer">
...
export default {
    ...
    computed: {
        ...
        filteredData() {
            ...
            const filteredRows = this.networkDevicesStore.syncClientData.filter(
                (row) => {
                    const columnsToSearch = ["id", "pppoeUserName", "pppoePassword"];

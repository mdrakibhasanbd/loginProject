                    ...
                    <div class="mb-4">
                        <div class="mt-4 grid gap-2 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select v-model="pppoeFormData.selectRouter" class="select select-primary w-full max-w-xs">
                            ...
                            <div>
                                ...
                                <select v-model="pppoeFormData.selectPackage" class="select select-primary w-full max-w-xs">
                            ...
                            <div>
                                ...
                                <input v-model="pppoeFormData.pppoeUserName" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            </div>

                            <div>
                                <h3 class="font-bold text-md mb-1">PPPoE Passwrod *</h3>
                                <input v-model="pppoeFormData.pppoePassword" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            </div>

                            <div>
                                <h3 class="font-bold text-md mb-1">Zone *</h3>
                                <select v-model="pppoeFormData.selectZone" class="select select-primary w-full max-w-xs">
                            ...
                            <div>
                                ...
                                <select v-model="pppoeFormData.selectSubZone" class="select select-primary w-full max-w-xs">
                                    <option disabled selected>....</option>
                    ...
                    <div class="mb-4">
                        <div class="mt-4 grid gap-2 sm:grid-cols-2">
                            <div>
                                ...
                                <input v-model="pppoeFormData.userName" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            ...
                            <div>
                                ...
                                <input v-model="pppoeFormData.userMobile" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            ...
                            <div>
                                ...
                                <input v-model="pppoeFormData.userEmail" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            </div>
                            ...
                            <div class="flex">
                                <div class="mr-2">
                                    ...
                                    <input v-model="pppoeFormData.userHouse" type="text" placeholder="Type here"
                                        class="input input-bordered input-primary w-full max-w-xs" />
                                </div>
                                <div>
                                    <h3 class="font-bold text-md mb-1">Road *</h3>
                                    <input v-model="pppoeFormData.userRoad" type="text" placeholder="Type here"
                                        class="input input-bordered input-primary w-full max-w-xs" />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input v-model="pppoeFormData.userAddress" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            ...
                            <div>
                                ...
                                <select v-model="pppoeFormData.userDivision" class="select select-primary w-full max-w-xs">
                                    <option disabled selected>....</option>
                                    <option>Mikrotik 1</option>
                                    <option>Mikrotik 2</option>
                                    <option>Mikrotik 3</option>
                            ...
                            <div>
                                ...
                                <select v-model="pppoeFormData.userDistrict" class="select select-primary w-full max-w-xs">
                                    <option disabled selected>....</option>
                                    <option>Mikrotik 1</option>
                                    <option>Mikrotik 2</option>
                                    <option>Mikrotik 3</option>
                            ...
                            <div>
                                ...
                                <select v-model="pppoeFormData.userThana" class="select select-primary w-full max-w-xs">
                                    <option disabled selected>....</option>
                                    <option>Mikrotik 1</option>
                                    <option>Mikrotik 2</option>
                                    <option>Mikrotik 3</option>
                    ...
                    <div class="mb-4">
                        <div class="mt-4 grid grid-cols-3 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input v-model="pppoeFormData.userNiDNumber" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            </div>
                    ...
                    <div class="mb-4">
                        <div class="mt-4 grid grid-cols-3 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <select v-model="pppoeFormData.userCableType" class="select select-primary w-full max-w-xs">
                                    <option>UTP</option>
                                    <option>Fiber</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input v-model="pppoeFormData.userRouterMacAddress" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            </div>

                            <div v-if="pppoeFormData.userCableType === 'Fiber'">
                                <h3 class="font-bold text-md mb-2">ONU MAC</h3>
                                <input v-model="pppoeFormData.userOnuMac" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            </div>


                            <div v-if="pppoeFormData.userCableType === 'Fiber'" class="flex">
                                <div class="mr-2">
                            ...
                            <div>
                                ...
                                <input v-model="pppoeFormData.userRequireCable" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            </div>

                            <div>
                                <h3 class="font-bold text-md mb-2">Type of Connectivity *</h3>
                                <select v-model="pppoeFormData.usertypeOfConnectivity"
                    ...
                    <div class="mb-4">
                        <div class="mt-4 grid grid-cols-3 gap-2 sm:grid-cols-2">
                            <div>
                                ...
                                <select v-model="pppoeFormData.userBillingType" class="select select-primary w-full max-w-xs">
                            ...
                            <div class="flex">
                                <div class="mr-2">
                                    ...
                                    <input v-model="pppoeFormData.userMonthlyBill" type="text" placeholder="Type here"
                                        class="input input-bordered input-primary w-full max-w-xs" />
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <input v-model="pppoeFormData.userConnectionDate" type="date" id="billing-date"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            ...
                            <div>
                                ...
                                <input v-model="pppoeFormData.userBillingCycle" type="datetime-local" id="billing-date"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            </div>
                            ...
                            <div>
                                ...
                                <input v-model="pppoeFormData.userReferenceName" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            </div>
                            <div>
                                <h3 class="font-bold text-md mb-1">Reference Mobile</h3>
                                <input v-model="pppoeFormData.userReferenceMobile" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            </div>

                            <div>
                                <h3 class="font-bold text-md mb-1">Billings Mobile</h3>
                                <input v-model="pppoeFormData.userBillingsMobile" type="text" placeholder="Type here"
                                    class="input input-bordered input-primary w-full max-w-xs" />
                            </div>
                            ...
                            <div>
                                <div class="form-control ">
                                    <label class="label">
                                        ...
                                        <input v-model="pppoeFormData.userAutomaticConnectionOff" type="checkbox"
    ...
    methods: {
        ...
        async submitForm() {
            ...
            try {
                ...
                const response = await api.post('/addPPPoEuser', this.pppoeFormData);
            ...
            console.log(this.pppoeFormData);
            this.closeModal();
